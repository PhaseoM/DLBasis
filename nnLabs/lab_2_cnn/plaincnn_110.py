...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.nnModel = nn.Sequential(
            ...
            nn.ReLU(),
            *normal_block(18, 16, 16),  # map_size: 32
            *normal_block(18, 16, 32),  # map_size: 16
            *normal_block(18, 32, 64),  # map_size: 8
...
def main():
    ...
    @unis.tee_output(conf.info_output_filepath + f"plain_{18 * 6 + 2}")
    def run():
        print(f"plain_{18 * 6 + 2}")
        ...
        with open(conf.pkl_dump_filepath + f"plain_{18 * 6 + 2}.pkl", "wb") as f:
