...
def exp():
    ...
    modelp, pred_h, figs = bpnn_cls.execute_cls(epochs=600, batch_size=32, hide_layer_size=64, threshold=0.20)
    ...
    # np.random.seed(random_seed)
    # test_loss, figs = bpnn_reg.execute_reg(epochs=5000, batch_size=100, hide_layer_size=64)
    # fig_arr.extend(figs)
